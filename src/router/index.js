...

  {
    ...
    children: [
      ...
      // },
      {
        path: 'fundList',
        name: 'FundList',
        component: () => import('@/views/table/FundList'),
        meta: { title: '基金信息', icon: 'table' }
      },
      {
        path: '/fundHistory',
        name: 'fundHistory',
        component: () => import('@/views/table/FundHistory')
      },
      {
        path: "/vueEcharts",
        name: "vueEcharts",
        component: () => import("@/views/table/VueEcharts")
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/user/AddUserComponent")
      },
    ]
  },
